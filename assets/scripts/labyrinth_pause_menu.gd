...
signal exit_labyrinth_requested
...
@onready var exit_labyrinth_button: Button = content_root.get_node("MenuColumn/ButtonStack/ExitLabyrinthButton")

@onready var menu_buttons: Array[Button] = [
	resume_button,
	exit_labyrinth_button,
]
...
func _ready() -> void:
	...
	exit_labyrinth_button.pressed.connect(func() -> void: exit_labyrinth_requested.emit())
