...
signal exit_cutscene_requested
...
@onready var skip_cutscene_button: Button = content_root.get_node("MenuColumn/ButtonStack/SkipCutsceneButton")
...
func _ready() -> void:
	...
	skip_cutscene_button.icon = _mirrored_exit_icon
	resume_button.pressed.connect(func() -> void: resume_requested.emit())
	skip_cutscene_button.pressed.connect(func() -> void: exit_cutscene_requested.emit())
