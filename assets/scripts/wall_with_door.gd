...
func open_doors() -> void:
	...
	right_pivot.global_rotate(Vector3.UP, deg_to_rad(right_door_opened_yaw_degrees))
	left_pivot.global_rotate(Vector3.UP, deg_to_rad(left_door_opened_yaw_degrees))
	_doors_opened = true
